...
import com.jaziel.crawler.process.thread.CrawlerThreadPool;
...
import com.jaziel.crawler.utils.DateUtils;
import com.jaziel.crawler.utils.HtmlParser;
import com.jaziel.model.crawler.core.label.HtmlLabel;
import com.jaziel.model.crawler.core.parse.ZipUtils;
...
import com.jaziel.utils.common.ReflectUtils;
...
public class CrawlerHtmlParsePipeline extends AbstractHtmlParsePipeline<CrawlerParseItem> {
     ...
     */
    @Override
    public void handelHemlData(CrawlerParseItem parseItem) {
