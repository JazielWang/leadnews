...
public class CrawlerNewsAdditionalServiceTest {
    ...
    public void testQueryList() {
        ...
        List<ClNewsAdditional> clNewsAdditionals =
                crawlerNewsAdditionalService.queryList(clNewsAdditional);
    ...
    public void testCheckExist() {
        boolean b =
                crawlerNewsAdditionalService.checkExist("https://blog.csdn.net/weixin_43976602/article/details/96971651");
